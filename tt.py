...
# Diretorio onde ficam as imagens 
# personalizadas de cada streamer
DIR_IMAGE = os.path.abspath(os.path.dirname("."))
DIR_IMAGE = os.path.join(DIR_IMAGE, "img")

# Unicode para o círculo vermelho e para a seta
...
def tweet(twitch, twitter, title, isPrint, streamer_type):

	# Obter o objecto API
	api = twitter_OAuth(streamer_type)

	hashtags = "#Twitch #live"
